...
class SCEASAR_OT_clear_all_materials(Operator):
...
def register():
    bpy.utils.register_class(SCEASAR_OT_clear_all_materials)


def unregister():
    bpy.utils.unregister_class(SCEASAR_OT_clear_all_materials)
